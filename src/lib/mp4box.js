...
BoxParser.SingleItemTypeReferenceBox = function(type, size, name, hdr_size, start) {
	BoxParser.Box.call(this, type, size, name);
	this.hdr_size = hdr_size;
	this.start = start;
}
...
ISOFile.prototype.setSegmentOptions = function(id, user, options) {
	...
	if (trak) {
		...
		if (options) {
			...
			if (options.rapAlignment) fragTrack.rapAlignment = options.rapAlignment;
		}
	}
}
...
// <reference path="DataStream.js" />
// <reference path="DataStream-write.js" />
// <reference path="DataStream-map.js" />
// <reference path="buffer.js" />
// <reference path="descriptor.js" />
// <reference path="box.js" />
// <reference path="box-parse.js" />
// <reference path="parsing/sampleentries/sampleentry.js" />
// <reference path="parsing/**/*.js" />
// <reference path="box-codecs.js" />
// <reference path="box-write.js" />
// <reference path="writing/**/*.js" />
// <reference path="box-unpack.js" />
// <reference path="box-diff.js" />
// <reference path="text-mp4.js" />
// <reference path="isofile.js" />
// <reference path="isofile-advanced-parsing.js" />
// <reference path="isofile-advanced-creation.js" />
// <reference path="isofile-sample-processing.js" />
// <reference path="isofile-item-processing.js" />
// <reference path="isofile-write.js" />
// <reference path="box-print.js" />
...
export { MP4Box, DataStream, BoxParser, MP4BoxStream };
